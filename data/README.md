...
`eval_results_v2_chunk1024.json` — evaluation results from a chunking experiment using chunk size 1024 with overlap 200. Generated by `evaluate.py` after rebuilding the vector store with updated parameters in `config.py`. 